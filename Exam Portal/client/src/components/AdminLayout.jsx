...
//   async function saveProfileToServer(updatedProfile) {
//     try {
//       const res = await fetch(`${API_BASE}/profile`, {
//         method: "PUT",
...
//       password: wantsPassword ? profileForm.newPassword : undefined,
//     };

//     /* --- SAVE TO BACKEND --- */
//     const ok = await saveProfileToServer(updatedProfile);
...
//       {/* ---------------- SIDEBAR ---------------- */}
//       <div
//         className={`fixed top-0 left-0 h-screen w-64 backdrop-blur-xl
//           bg-white/70 dark:bg-[#0a0a0a]/70 border-r border-white/30 dark:border-gray-800
//           shadow-[0_8px_30px_rgb(0,0,0,0.12)] px-6 py-6 z-40 transition-transform duration-300
...
//           <button className="flex items-center gap-2 text-[15px] text-gray-700 dark:text-gray-300 hover:text-red-600 transition">
//             <LogOut size={18} />
//             <span>Logout</span>
//           </button>
//         </div>
...
//         <div
//           className="w-full h-16 px-4 sm:px-6 flex items-center justify-between
//             bg-white/80 dark:bg-[#0d0d0d]/80 backdrop-blur-xl 
//             border-b border-gray-200 dark:border-gray-800 shadow sticky top-0 z-40"
//         >
//           <button
//             onClick={() => setSidebarOpen(true)}
//             className="md:hidden p-2 bg-gray-200 dark:bg-gray-800 rounded-lg hover:scale-105 transition"
//           >
...
//               <div className="absolute w-5 h-5 bg-white rounded-full top-0.5 left-0.5 transition-all peer-checked:translate-x-6" />
//             </label>
...
//                 <Bell size={22} />
//                 {unreadCount > 0 && (
//                   <span className="absolute -top-2 -right-2 bg-red-600 text-white w-4 h-4 rounded-full text-[10px] flex items-center justify-center">
//                     {unreadCount}
//                   </span>
//                 )}
//               </button>
...
//               {/* Notification Popup */}
//               {openNotif && (
//                 <div className="absolute right-0 mt-3 w-80 sm:w-96 max-h-[60vh] overflow-y-auto bg-white/90 dark:bg-[#0e0f10]/90 backdrop-blur-xl shadow-2xl rounded-xl p-4 border z-50">
//                   <div className="flex justify-between mb-3">
//                     <h2 className="font-semibold text-lg">Notifications</h2>
//                     <div className="flex gap-3">
//                       <button onClick={markAllRead} className="text-sm text-blue-600">Mark all read</button>
//                       <button onClick={clearAll} className="text-sm text-red-600">Clear all</button>
//                     </div>
//                   </div>

//                   {notifications.length === 0 ? (
//                     <p className="text-center text-sm text-gray-500 py-3">No notifications</p>
//                   ) : (
//                     notifications.map((n) => (
//                       <div
//                         key={n.id}
//                         className={`flex items-start gap-3 p-3 border rounded-xl mb-2 ${
//                           n.read
//                             ? "bg-white/30 dark:bg-[#222]/40"
//                             : "bg-[#eef2ff] dark:bg-[#182132]"
//                         }`}
//                       >
//                         <Bell size={18} className="text-[#4f6df5] mt-1" />
...
//       {/* ---------------- PROFILE POPUP ---------------- */}
//       {profileOpen && loadedProfile && (
//         <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-[999]">
//           <div className="bg-white dark:bg-[#1a1a1a] w-[90%] max-w-lg rounded-2xl shadow-xl p-6 relative text-black dark:text-white max-h-[90vh] overflow-y-auto">
